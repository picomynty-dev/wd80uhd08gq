...
export const STORAGE_KEY = 'myFitPlanStateV30A1';
export const LEGACY_KEYS = ['myFitPlanStateV30A', 'myFitPlanStateV22', 'myFitPlanStateV21', 'myFitPlanStateV2', 'myFitPlanStateV1'];
export const APP_VERSION = '3.0.0-alpha.1.1';
