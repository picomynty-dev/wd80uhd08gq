...
import { getAllExercises, getExercise } from './exercises.js?v=44';
import { createPlanExercise, trainingRules } from './plans.js?v=44';
import { numberValue } from './utils.js?v=44';
