...
import { getAllExercises, getExercise } from './exercises.js?v=43';
import { createPlanExercise, trainingRules } from './plans.js?v=43';
import { numberValue } from './utils.js?v=43';
