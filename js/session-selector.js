...
import { getAllExercises, getExercise } from './exercises.js?v=46';
import { createPlanExercise, trainingRules } from './plans.js?v=46';
import { numberValue } from './utils.js?v=46';
