...
import { getAllExercises, getExercise } from './exercises.js?v=42';
import { createPlanExercise, trainingRules } from './plans.js?v=42';
import { numberValue } from './utils.js?v=42';
