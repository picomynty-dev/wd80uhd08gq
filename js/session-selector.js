...
import { getAllExercises, getExercise } from './exercises.js?v=421';
import { createPlanExercise, trainingRules } from './plans.js?v=421';
import { numberValue } from './utils.js?v=421';
