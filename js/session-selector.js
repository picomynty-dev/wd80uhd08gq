...
import { getAllExercises, getExercise } from './exercises.js?v=47';
import { createPlanExercise, trainingRules } from './plans.js?v=47';
import { numberValue } from './utils.js?v=47';
