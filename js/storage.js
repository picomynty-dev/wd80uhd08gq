import { clone, isoDay, numberValue, uid } from './utils.js?v=46';
import { buildPlan, normalizePlan, trainingRules } from './plans.js?v=46';
import { normalizePlanner } from './calendar-planner.js?v=46';
...
export const APP_VERSION = '4.6 Beta Pilot Sandbox';
